...
/**The ObjectData class supports write and read object data to file at specific location.<br>Make sure your object class was "implements Serializable".
 * @author AnLaVN
 */
public class ObjectData {
     ...
     * @param filePath specific location of file, file name extension should be ".dat".
     ...
     * @param filePath specific location of file.
