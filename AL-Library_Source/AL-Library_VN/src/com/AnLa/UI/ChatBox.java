...
public class ChatBox extends JScrollPane{
     ...
     * @param message là tin nhắn bạn muốn thêm.<br>
     */
     ...
     * @param message là thông báo bạn muốn thêm.<br>
     */
     ...
     * @param font là phông chữ mong muốn của bạn.<br>
     */
     ...
     * @param BorderRadius là bán kính đường viền mong muốn của bạn.<br>
     */
     ...
     * @param NotifiColor là màu mong muốn của bạn.<br>
     */
     ...
     * @param StartColor là màu cuối của màu loang ở bên trái.<br>
     * @param EndColor là màu cuối của màu loang ở bên phải.<br>
     * @param GradientFocus là vị trí mà màu loang nên tập trung (chấp nhận giá trị âm)<br>
     */
