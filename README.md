...
🫙 Sử dụng tính năng này với [tệp Jar](https://github.com/AnLaVN/AL-Library/releases/download/v6.70.10/YourGPTManager.zip) / Use this feature with [Jar files](https://github.com/AnLaVN/AL-Library/releases/download/v6.70.10/YourGPT_Runner.zip) 🫙
